...
import Back from '../assets/images/Vector(25).png';
    ...
    <Stack.Navigator
      ...
      <Stack.Screen
        ...
        options={({route, navigation}) => ({
          headerLeft: () => <Image source={getFocusedRouteNameFromRoute(route) === 'Calls'? Back : Bar} style={{marginLeft: hp(23)}} />,
          headerRight: () => (
            <Image source={Search} style={{marginRight: hp(23)}} />
          ),
          headerTitleAlign: 'center',
          headerTitle: (
            getFocusedRouteNameFromRoute(route) === 'Calls'?
